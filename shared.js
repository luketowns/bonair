// shared.js - Consolidated layout engine for Bonair v1.4.0
(function() {
    ...
    // 2. Configure Tailwind Theme Colors on Load
    ...
    // 3. Inject Navigation & Footer once the DOM is ready
    document.addEventListener("DOMContentLoaded", function() {
        ...
        <nav class="bg-slate-950 text-white shadow-md border-b-4 border-aviationRed">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    ...
                    <!-- User Profile Corner (Bertie Beaver) -->
        ...
        // Prep the body to house our header
        ...
        <footer class="bg-slate-950 text-slate-500 text-xs py-4 border-t border-slate-900 mt-auto">
            <div class="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-2">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <span class="font-mono bg-slate-900 px-2.5 py-1 rounded border border-slate-800 text-slate-400">v1.4.0-build</span>
                </div>
            </div>
        </footer>`;
